...
<link href="<?php echo $baseurl ?>/assets/admin/pages/css/blog.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo $baseurl ?>/assets/admin/pages/css/news.css" rel="stylesheet" type="text/css"/>
...
<link href="<?php echo $baseurl ?>/assets/admin/layout4/css/layout.css" rel="stylesheet" type="text/css"/>
<link id="style_color" href="<?php echo $baseurl ?>/assets/admin/layout4/css/themes/light.css" rel="stylesheet" type="text/css"/>
<link href="<?php echo $baseurl ?>/assets/admin/layout4/css/custom.css" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
...
<body class="page-header-fixed page-sidebar-closed-hide-logo ">
	<!-- BEGIN HEADER -->
	<?php require_once 'master_header.php'; ?>
	<!-- END HEADER -->
<div class="clearfix">
</div>
<!-- BEGIN CONTAINER -->
<div class="page-container">
	<!-- BEGIN SIDEBAR -->
	<?php require_once 'master_menu.php'; ?>
	<!-- END SIDEBAR -->
	<!-- BEGIN CONTENT -->
...
<!-- END CONTAINER -->
<!-- BEGIN FOOTER -->
<?php require_once 'master_footer.php'; ?>
<!-- END FOOTER -->
...
<script src="<?php echo $baseurl ?>/assets/admin/layout4/scripts/layout.js" type="text/javascript"></script>
<script src="<?php echo $baseurl ?>/assets/admin/layout4/scripts/demo.js" type="text/javascript"></script>
<script>
